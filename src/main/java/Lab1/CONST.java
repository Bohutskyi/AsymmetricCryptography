...
public class CONST {
    ...
    public static final double TEST_THREE_QUANTILE_FOR_ONE = 2.326348;
    public static final double TEST_THREE_QUANTILE_FOR_TWO = 1.644854;
    public static final double TEST_THREE_QUANTILE_FOR_THREE = 1.281552;
